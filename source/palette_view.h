...
#ifndef RME_PALETTE_VIEW_H_
#define RME_PALETTE_VIEW_H_

#include "palette_common.h"
#include <wx/simplebook.h>

wxDECLARE_EVENT(EVT_PALETTE_CONTENT_CHANGED, wxCommandEvent);
...
class PaletteView : public wxPanel {
public:
	PaletteView(wxWindow* parent, const TilesetContainer &tilesets);
	~PaletteView() = default;
	...
	// Get a summary string for the tab ear (e.g. "Terrain: Nature")
	wxString GetTabSummary() const;
	...
	// Called when this view becomes active/inactive
	void OnActivateView();
